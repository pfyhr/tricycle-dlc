...
|---|--:|--:|
| Lotus Elise best lap, Knutstorp | **1:09.5** | 1:11.1 |
| Mazda MX-5 best lap, Knutstorp | **1:08.0** | 1:10.2 |
...
The remaining ~2 s sits in the line model, not the car: the sim's track has no kerbs to cut
