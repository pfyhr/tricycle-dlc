...
<body><div class="wrap">
<header><h1>Planar lap gallery</h1><span class="tag">tricycle · OpenModelica · min-curvature line</span>
<a class="chase" style="margin:0 0 0 auto;padding:8px 14px;font-size:13px" href="webgui.html">⚡ Live simulator</a></header>
...
fastest recorded lap is overlaid on the simulated speed trace. For live setup sliders
(downforce, grip, ballast, balance), open the <a href="webgui.html">⚡ live simulator</a>.</p>
<div class="controls">
